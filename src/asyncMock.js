const products = [
  {
    ...
    stock: 5,
    description: "La historia de Cal Kestis continúa en el juego aclamado por la crítica STAR WARS Jedi: Survivor™, una nueva aventura épica que lo llevará a nuevas fronteras en una lucha por proteger la galaxia y evitar que se suma en la oscuridad.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    stock: 5,
    description: "Un drama épico donde el extenso mundo de las Tierras Intermedias espera ser descubierto. Los jugadores podrán personalizar el aspecto de su personaje y desarrollarlo según su estilo de juego, combinando libremente armas, armaduras y magia para enfrentar amenazas desconocidas.",
  },
  {
    id: "5",
    name: "GOD OF WAR",
  ...
  },
  {
    ...
    stock: 5,
    description: "En esta entrega, los jugadores deberán luchar y evolucionar en varios modos de juego de la mano de su personaje favorito para salvar la Tierra. Podrán elegir entre clásicos como Batman, Superman, Supergirl, Flash, Aquaman o Wonder Woman y nuevos villanos como Atrocitus, Gorilla Grodd y Deadshot.",
  },
  {
    id: "7",
  ...
  },
  {
    ...
    stock: 5,
    description: "Esta historia de acción y aventura en mundo abierto se ambienta en Night City, una megalópolis obsesionada con el poder y la modificación corporal. Los jugadores estarán en la piel de un mercenario que busca un implante único que es la clave para la inmortalidad.",
  },
  {
    id: "14",
    name: "HALO INFINITE",
    ...
    stock: 5,
    description: "Halo Infinite es un juego de acción en primera persona de ciencia ficción perteneciente a la mítica saga de título Halo. Con un nuevo motor gráfico, más potente, una iluminación realista y gráficos en 4K, el Jefe Maestro regresa para luchar contra los restos del Pacto y nuevos enemigos.",
  },
  {
    id: "15",
    ...
    stock: 5,
    description: "Con el asalto de Bebop y Rocksteady al Canal 6 para robar dispositivos ultramolones para apoyar el último plan malvado de Krang y Shredder, las tortugas tienen que pelear por una serie de escenarios clásicos de la franquicia. Ayuda al temible cuarteto a aplastar a soldados del Pie, guerreros triceratons y soldados de piedra para enviarlos de vuelta a la Dimensión X.",
  },
  {
    id: "16",
    ...
    stock: 5,
    description: "Ambientada en un mundo abierto de la Edad Oscura, que abarca desde las frías costas de Noruega hasta los hermosos reinos de Inglaterra, los jugadores se convertirán en un legendario guerrero vikingo que deberá vencer a sus enemigos en la búsqueda por ganarse un lugar entre los dioses en Valhalla.",
  },
  {
    id: "17",
  ...
  },
  {
    ...
    stock: 5,
    description: "Sea of Stars cuenta la historia de dos Niños del Solsticio que combinan los poderes del sol y de la luna para realizar magia de eclipse, la única fuerza capaz de repeler a las monstruosas creaciones de un malvado alquimista conocido como El Fleshmancer.",
  },
  {
    id: "19",
  ...
  },
  {
    ...
    stock: 5,
    description: "Atrapa, combate y entrena Pokémon en la región de Paldea, una vasta tierra llena de lagos, cimas montañosas, páramos, poblaciones pequeñas y grandes ciudades. Explora un mundo completamente abierto a tu propio paso y recorre a través de la tierra, el agua y el aire a lomos del Pokémon legendario Koraidon, en Pokémon Scarlet, o sobre el Pokémon legendario Miraidon, Pokémon Violet.",
  },
];
